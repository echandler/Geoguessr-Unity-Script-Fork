...
const globalScriptVersion = "7.4.2.5";
        ...
        constructor(...args) {
            ...
            if (savedCustomStyleInfo && savedCustomStyleInfo.doPersist){
                google.maps.event.addListenerOnce(this, 'idle', function(){
                    ...
                    this.unity_is_blocking_style_changes = true;
                });
            }
...
function openCustomMapInput(){
    ...
    body.style.cssText = `position: absolute; width: fit-content; /* margin-inline: auto; */ top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; background-color: rgba(186, 85, 211, 0.8); padding: 1em; border-radius: 1em;`; body.innerHTML = `
        <div>
            ...
            <div style="margin-bottom: 1em;">
            Custom styles <a style="margin-left: 4em; float:right; color: blue; cursor: pointer;" href="https://mapstyle.withgoogle.com/" target="_blank">Google map styling wizard</a>
            </div>
            <div>
    ...
    const mapStylesCodes = { 
        ...
        "llll": { id:  "CG's 📸travel-pics-game",
                  fn : function(id){
                            const coverageLayer = new google.maps.ImageMapType({
                                getTileUrl({ x, y }, z) {
                                    //return `https://localhost:4443/tiles/${z}/${x}/${y}.png`
                                    //return `http://127.0.0.1:8000/tiles/${z}/${x}/${y}.png`
                                    return `data:image/png;base64,`;
                                   // return `http://127.0.0.1:8080/tiles/${z}/${x}/${y}.webp`
                                    //return `https://echandler.github.io/a/misc/tiles/${z}/${x}/${y}.webp`;
                                    //return `https://192.168.0.31:4443/tiles/${z}/${x}/${y}.png`;
                                    //return `https://test123abc.wuaze.com/tiles/${z}/${x}/${y}.png`
                                },
                                maxZoom: 20,
                                tileSize: new google.maps.Size(256, 256),
                            })
